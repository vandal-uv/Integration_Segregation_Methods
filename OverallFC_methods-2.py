...
def permutation_test(Y1,Y2,X1,X2,permutations,iters,tolerance,
...
if __name__=='__main__':    
    ...
    ###Permutation test
    t_real,mu,p_val,statistic,means,surr_std = permutation_test(GE_Group_1,GE_Group_2,
                                                                Overall_FC_Group_1,
                                                                Overall_FC_Group_2,
                                                                10000,1000,0.01,
                                                                parametric=True,paired=False)  
    
    #The permutation test also suggests that global efficiency was higher in group 1.
